    ...
    <flux:modal name="client-import-modal" class="md:w-[52rem]">
        <div class="mb-5">
            ...
            <flux:subheading>Upload file CSV untuk menambahkan banyak klien sekaligus. Hanya kolom <strong>name</strong>
                yang wajib diisi.</flux:subheading>
        </div>
                        ...
                        <thead class="bg-zinc-50 dark:bg-zinc-800 sticky top-0">
                            <tr>
                                ...
                                <th class="p-2 text-left text-xs font-semibold text-zinc-500 uppercase tracking-wide">
                                    Perusahaan</th>
                                <th class="p-2 text-left text-xs font-semibold text-zinc-500 uppercase tracking-wide">Email
                                </th>
            ...
            <div
                ...
                <div>
                    ...
                    <div class="text-sm text-green-700 dark:text-green-400 mt-0.5">
                        <span class="font-medium">{{ $importedCount }}</span> klien berhasil diimport.
                        @if($skippedCount > 0)
                ...
                @if(count($rows) > 0 && !$importDone)
                    ...
                    <flux:button wire:click="processImport" variant="primary" icon="arrow-up-tray"
                        ...
                        <span wire:loading.remove wire:target="processImport">
                            Proses Import ({{ $validCount }} klien)
                        </span>
