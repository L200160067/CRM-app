<div>
                        ...
                        <flux:table.cell colspan="3" class="p-0">
                            <div class="flex flex-col items-center justify-center py-20 whitespace-normal">
                                ...
                                @else
                                    ...
                                    <flux:text class="text-zinc-500 dark:text-zinc-400 text-center max-w-sm">Data klien yang
                                        Anda
    ...
    <flux:modal name="client-delete-modal" class="w-full md:w-[32rem]">
        <div class="mb-6">
    ...
    <flux:modal name="client-force-delete-modal" class="w-full md:w-[32rem]">
        <div class="mb-6">
