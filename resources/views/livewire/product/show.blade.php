<div>
    <flux:modal name="product-show-modal" class="w-full md:w-[40rem]">
        @if($product)
            <div class="mb-6">
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <flux:text class="text-xl font-bold">Rp {{ number_format($product->default_price, 2, ',', '.') }}
                    </flux:text>
                </div>
                ...
                <div>
                    ...
                    <flux:text>
                        {{ $product->description ?? 'Tidak ada penjelasan lebih lanjut disediakan untuk produk ini.' }}
                    </flux:text>
                </div>
