<div>
                    ...
                    <flux:table.cell>
                        <flux:dropdown>
                            ...
                            <flux:menu>
                                ...
                                <flux:menu.separator />
                                <flux:menu.item wire:click="confirmDelete({{ $user->id }})" icon="trash" variant="danger">
                ...
                <flux:table.row>
                    <flux:table.cell colspan="4" class="p-0">
                        <div class="flex flex-col items-center justify-center py-20 whitespace-normal">
                            ...
                            <flux:text class="max-w-sm mb-6 text-center text-zinc-500 dark:text-zinc-400">Silakan tambahkan
    ...
    <flux:modal name="user-create-modal" class="md:w-[32rem]" wire:model="showCreateModal">
    ...
    <flux:modal name="user-delete-modal" class="min-w-[22rem]" wire:model="deletingUserId">
